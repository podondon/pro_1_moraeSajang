...
<style>
        ...
        #msgList .msgListInner .msgListInnerBox .msgListBox .msg .msgForm .centerArea .rcvDate{position:relative; top:40px; font-size:16px; color:#888;}
    ...
    <section id="msgList">
        <div class="msgListInner">
            <div class="msgListInnerBox">
                    ...
                    <div class="msg">
                        <div class="msgForm">
                            ...
                            <div class="centerArea">
                                ...
                                <p class="rcvDate">${item.sentDate}</p>
                            </div>
                            <div class="rightArea">
                                <a href="rcvList"><svg width="22" height="22" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" class="returnList">
                                ...
                                <a href="rcvDel?messagesNo=${item.messagesNo}" onclick="return del()"><svg width="22" height="22" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="delImg">
                ...
                <a href="reply?senerNickName=${item.senerNickName}"><div class="btnBox">답장하기</div></a>
            </div>
        </div>
    </section>
</body>
...
$(document).ready(function() {
	$.ajax({
		type: 'post',
		url: 'msgRead.ajax',
		data: {'messagesNo':${item.messagesNo}},
		dataType: 'json',
